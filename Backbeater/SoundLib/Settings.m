...
{
    NSInteger MAX_TEMPO = [Constants MAX_TEMPO];
    NSInteger MIN_TEMPO = [Constants MIN_TEMPO];
...
-(void) restoreState
{
    ...
    if ([userDefaults objectForKey:@"metronomeTempo"] != nil) {
        ...
        changed = YES;
        _metronomeTempo = [Constants DEFAULT_TEMPO];
    }
    ...
    if ([userDefaults objectForKey:@"lastPlayedTempo"] != nil) {
        ...
        changed = YES;
        _lastPlayedTempo = [Constants DEFAULT_TEMPO];
    }
